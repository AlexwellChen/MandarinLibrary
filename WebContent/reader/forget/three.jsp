...
<body
	...
	<form id="msform" action="" onsubmit="return check()">
		...
		<fieldset
			style="display: block; border-radius: 25px; background: rgb(236, 233, 250, 0.9);">
			<h2 class="fs-title">reset password</h2>
			<div class="fs-bag">
				<input name="action" type="hidden" value="3"> <input
					id="accountpwd" name="accountpwd" class="fs-input3"
					placeholder="input new password" type="password">
			</div>
			<div class="fs-bag">
				<input id="checkpwd" name="checkpwd" class="fs-input3"
					placeholder="input new password" type="password">
			</div>
			<div class="fs-bag">
