...
<body
	style="background: url('../../imgs/1.jpg'); background-size: cover;">
	...
	<form id="msform" action="" onsubmit="return check()">
		...
		<fieldset
			style="display: block; padding: 20px 20px; border-radius: 25px; background: rgb(236, 233, 250, 0.9);">
			<h2 class="fs-title">input account</h2>
			<div class="fs-bag">
				<input name="action" type="hidden" value="1"> <input
					style="padding-left: 15px; padding-right: 0; width: 708px;"
					id="accountkey" name="accountkey" class="fs-input1"
					placeholder="account conot be empty" type="text">
				<p id="accounttip" class="magcws"></p>
			</div>
			<input class="next action-button" value="next"
				style="margin-top: 50px;" type="submit">
		</fieldset>
